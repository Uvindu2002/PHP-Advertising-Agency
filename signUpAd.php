...
if(isset($_POST['submit'])){
   ...
   if(empty($fname)){
      ...
      $query = "SELECT * FROM `advertisers` WHERE email = '$email' or mobile = '$mobile'";
      ...
      if($rs->num_rows > 0){
         ...
         $insert = "INSERT INTO `advertisers`(email, fname, lname, password, mobile, joined_date, status) VALUES('$email','$fname','$lname','$password','$mobile','$date','1')";
...
<body>
   ...
   <div class="container">
      ...
      <section class="col5">
      <div class="ffeild" style="float: left;">
         <button type="button" class="btn1" onclick="window.location.href = 'signUpPub.php';">Publisher</button>
      </div>
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <div class="ffeild">
            ...
            <div class="col4">
               <button type="button" class="fbtn" onclick="window.location.href = 'signInAd.php';">Already have an account? Sign In</button>
            </div>
         </div>
      </form>
