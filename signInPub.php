...
<body>
   ...
   <div class="container">
      ...
      <section class="col5">
         <div class="ffeild">
            <button type="button" class="btn1" onclick="window.location.href = 'signInAd.php';">Advertiser</button>
         </div>
         ...
         <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="ffeild">
               ...
               <div class="col2">
                  <a href="forgotPasswordPub.php" class="" onclick="forgotPassword();">Forgot Password</a>
               </div>
            </div>
            <div class="ffeild">
               <div class="col4">
               ...
               <div class="col4">
                  <button type="button" class="fbtn" onclick="window.location.href = 'signUpPub.php';">Already have an account? Sign In</button>
               </div>
            </div>
